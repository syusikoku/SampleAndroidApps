...
public class PicListFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_test_imglist, container, false);
        return rootView;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter(new ImgListAdapter(mCtx, DataUtils.imgUrls().subList(0, 10)));
        ...
        recyclerView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                LogUtils.e("PicListFragment height = " + height);
